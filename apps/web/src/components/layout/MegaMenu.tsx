    ...
    columns: [
      {
        ...
        subtitle: 'hUMI Fresh',
        products: [
          { label: '~9,000 BTU · <25 m²', slug: 'pearl-premium-2-5-kw' },
          { label: '~12,000 BTU · 25-35 m²', slug: 'pearl-premium-3-5-kw' },
          { label: '~18,000 BTU · 35-50 m²', slug: 'pearl-premium-5-0-kw' },
          { label: '~24,000 BTU · 50-70 m²', slug: 'pearl-premium-7-1-kw' },
        ],
      },
      {
        title: 'Revive Plus',
        subtitle: 'UVC 99.9%',
        products: [
          { label: '~9,000 BTU · <25 m²', slug: 'revive-plus-2-5-kw' },
          { label: '~12,000 BTU · 25-35 m²', slug: 'revive-plus-3-5-kw' },
          { label: '~18,000 BTU · 35-50 m²', slug: 'revive-plus-5-0-kw' },
          { label: '~24,000 BTU · 50-70 m²', slug: 'revive-plus-7-1-kw' },
        ],
      },
    ],
  },
