      ...
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Suntem aici să te ajutăm cu orice întrebare despre produsele noastre.
          </p>
        </div>
        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-3">
          ...
          <div className="rounded-2xl bg-gray-50 p-8 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">Luni - Vineri, 9:00 - 18:00</p>
          </div>
          ...
          <div className="rounded-2xl bg-gray-50 p-8 text-center">
            ...
            <a href={`mailto:${CONTACT.email}`} className="mt-2 block text-sky-600 hover:text-sky-700">
              {CONTACT.email}
            </a>
            <p className="mt-1 text-sm text-gray-500">Răspundem în maxim 24h</p>
          </div>
        ...
        <div className="mt-16 text-center">
          <h2 className="text-lg font-semibold text-gray-900">Urmărește-ne</h2>
